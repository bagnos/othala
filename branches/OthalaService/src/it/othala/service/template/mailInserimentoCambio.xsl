...
<body style="padding:4px;font-family: Helvetica Neue,Helvetica,Arial,sans-serif;line-height: 1.42857143;font-size:14px;">
	...
	<br />
	<br />
	la  tua richiesta di Cambio è stata correttamente registrata. <br />
	Ti preghiamo di completare correttamente la procedura di Cambio come descritto.<br />
	Quando la richiesta sara accettata ti informeremo con un e-mail.

    </p>
	<div>
		<label style="display:inline-block;width:250px;"><b>RIEPILOGO CAMBIO NUMERO: </b></label>
