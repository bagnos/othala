...
public class OrderTest {
	...
	public void test1() {
		...
		try {
			...
			// ArticleFullDTO artFull =
			// productDao.getArticleFull(article.getPrdFullDTO().getIdProduct(),
			// article.getPgArticle(), "it");

			List<OrderFullDTO> lsOf = OthalaFactory.getOrderServiceInstance()
					.getOrders(null, "1", null);
	...
	public void Test2() {
		...
		ProductFullNewDTO prod = new ProductFullNewDTO();
	...
	// @Test
	/*
	 * public void Test3(){ try{
	 * OthalaFactory.getOrderServiceInstance().confirmOrderPayment("ABC1234", 2,
	 * TypeStateOrder.COMPLETED); } catch(StockNotPresentException ex){
	 * ex.printStackTrace(); }
	 * 
	 * 
	 * }
	...
	public void Test4() {
		...
		OthalaFactory.getOrderServiceInstance().confirmOrderDelivery(
				"PPPPP1234", 2);
