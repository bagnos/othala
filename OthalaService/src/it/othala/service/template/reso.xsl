...
<body style="padding:4px;font-family: Helvetica Neue,Helvetica,Arial,sans-serif;line-height: 1.42857143;font-size:14px;">
	<br />
	<div>
		<label style="display:inline-block;width:100%;"><b>1: Inserire la Distinta di Reso dentro al Pacco</b></label>
	</div>	
	<div>
		<label style="display:inline-block;width:100%;"><b>2: Apporre l'Etichetta di Reso sul pacco da spedire</b></label>
	</div>
	<div>
	...
	<br />	
	<div>
		<label style="display:inline-block;width:250px;"><b>DISTINTA DI RESO :</b></label>
	</div>
	<br />	
	<div>
	<div>
